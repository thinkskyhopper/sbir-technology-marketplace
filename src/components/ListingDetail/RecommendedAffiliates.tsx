        ...
        {affiliates.map(affiliate => {
          ...
          return (
            <a 
              ...
              className="flex flex-col items-center space-y-2 py-4 px-2 rounded-lg border border-border hover:bg-accent transition-colors"
            >
              <ProfileAvatar
                photoUrl={affiliate.photo_url}
                name={affiliate.full_name}
                className="w-16 h-16"
                fallbackClassName="bg-[#006ede] text-white text-lg"
              />
