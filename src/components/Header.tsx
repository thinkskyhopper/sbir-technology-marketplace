        ...
        <div className="flex items-center justify-between">
          ...
          <form onSubmit={handleSearch} className="flex-1 max-w-md mx-8">
            <div className="relative">
              ...
              <Input type="text" placeholder="Search..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="pl-10 bg-secondary/50 border-border" />
            </div>
          </form>
          ...
          <div className="flex items-center space-x-4">
            {user ? <>
                <Button variant="outline" onClick={onPostListingClick} className="border-primary/20 hover:border-primary/40">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-56">
                    <div className="px-2 py-1.5 text-sm">
                      ...
                      {isAdmin && <div className="flex items-center text-xs text-muted-foreground mt-1">
                          <Shield className="w-3 h-3 mr-1" />
                          Administrator
                        </div>}
                    </div>
                    <DropdownMenuSeparator />
                    {isAdmin && <DropdownMenuItem onClick={handleAdminClick}>
