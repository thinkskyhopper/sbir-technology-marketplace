-- Drop and recreate the get_public_listings_with_profiles function to include recommended affiliates
...
RETURNS TABLE(
  ...
  recommended_affiliate_1_full_name text,
  recommended_affiliate_2_id uuid,
  recommended_affiliate_2_full_name text
)
LANGUAGE sql
SECURITY DEFINER
...
AS $$
  SELECT 
    ...
    aff1.full_name as recommended_affiliate_1_full_name,
    sl.recommended_affiliate_2_id,
    aff2.full_name as recommended_affiliate_2_full_name
