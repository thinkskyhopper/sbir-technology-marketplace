...
-- Update the handle_new_user function to store first and last names separately
...
BEGIN
  ...
  INSERT INTO public.profiles (id, email, full_name, first_name, last_name, display_email)
  VALUES (
    NEW.id, 
    NEW.email,
    full_name_value,
